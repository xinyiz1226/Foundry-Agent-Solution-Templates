...
> **Historical plan, superseded September 17, 2026.** Preserve this document as
> the record of the standalone-workbench direction and G0-G4 gates. The
> [current delivery plan](implementation-plan.md) prioritizes CU + Fabric and
> replaces its architecture and delivery order. Unfinished historical gates
> are not new prerequisites unless the selected integration still needs them.
